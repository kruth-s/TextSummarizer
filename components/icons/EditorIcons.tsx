...
export const ExclamationTriangleIcon: React.FC<{ className?: string }> = ({ className = "h-12 w-12" }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
        viewBox="0 0 24 24" 
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className = "h-12 w-12" }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
        viewBox="0 0 24 24" 
        ...
        className={className}
    >
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311V21m-3.75 0h.008v.008h-.008v-.008zm0 0H9m7.5 0h.008v.008h-.008v-.008zm0 0h-3.188m-4.5 0h.008v.008h-.008v-.008zM12 3.75a6 6 0 016 6c0 1.564-.44 3.023-1.22 4.281l-1.282 2.052a.75.75 0 01-1.296 0L12 14.281 9.702 18.25a.75.75 0 01-1.296 0L7.22 14.031A6.002 6.002 0 016 9.75a6 6 0 016-6z" />
    </svg>
);
